...
class _ChatBotScreenState extends State<ChatBotScreen> implements NetworkResponse {
  ...
  bool isTyping = false;
  String searchValue = "";
  String senderPic = avatarImageUrl + (sharedPreferences!.getString(avatarKey) ?? "");
        ...
        appBar: AppBar(
          ...
          title: Column(
            ...
            children: [
              Text(
                "Emily",
                style: TextStyle(fontSize: size.width * numD05, color: Colors.black, fontWeight: FontWeight.w600),
              ),
            ],
          ),
          centerTitle: false,
        ...
        body: Column(
          ...
          children: [
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Column(
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                constraints: BoxConstraints(maxWidth: size.width * numD60),
                                                ...
                                                child: Text(
                                                  ...
                                                  style: TextStyle(color: Colors.black, fontSize: size.width * numD035, fontWeight: FontWeight.w400),
                                                ),
                                              ),
                                              SizedBox(
                                              ...
                                              Text(
                                                dateTimeFormatter(dateTime: chatList[index].time, format: "dd MMM yyyy hh:mm a"),
                                                style: TextStyle(fontSize: size.width * numD03, color: colorGoogleButtonBorder, fontWeight: FontWeight.w400),
                                              ),
                                              SizedBox(
                                          ...
                                          Container(
                                              ...
                                              decoration: BoxDecoration(
                                                borderRadius: BorderRadius.circular(size.width * numD07),
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Visibility(
                                                          visible: chatList[index].isNavigate,
                                                          child: Padding(
                                                        ...
                                                        Visibility(
                                                          visible: chatList[index].hasShownFirstFailMsg,
                                                          child: Padding(
                                                            padding: const EdgeInsets.only(top: 8),
                                                            child: Row(
                                                              children: [
                                                                commonElevatedButton(
                                                                  ...
                                                                  commonButtonStyle(size, colorThemePink),
                                                                  () {
                                                                    sendLocalMessage(true, "Loved our chat! Now handing you over to a real person for extra support.");
                                                                    resetFailCount();
                                                                  },
                                                                ),
                                                                SizedBox(width: 8),
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                          ...
                                          border: Border.all(width: 1.5, color: colorSwitchBack)),
                                      child: Lottie.asset("assets/lottieFiles/typing.json", height: size.width * numD10, width: size.width * numD16),
                                    ),
                                  ],
                                ),
                              ),
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Text(
                                      ...
                                      style: TextStyle(color: Colors.black, height: 1.3, fontSize: size.width * numD035, fontWeight: FontWeight.w400),
                                    ),
                                  ),
                                  SizedBox(
                                    height: size.width * numD01,
                                  ...
                                  Text(
                                    dateTimeFormatter(dateTime: DateTime.now().toString(), format: "dd MMM yyyy hh:mm a"),
                                    style: TextStyle(fontSize: size.width * numD03, color: colorGoogleButtonBorder, fontWeight: FontWeight.w400),
                                  ),
                                  SizedBox(
                                    height: size.width * numD02,
            ...
            Container(
              ...
              decoration: BoxDecoration(border: Border.all(color: Colors.grey.shade300), borderRadius: BorderRadius.circular(size.width * numD03)),
              child: Row(
                children: [
                  Expanded(
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      if (messageController.text.isNotEmpty) {
                        ...
                        chatList.add(ChatModel(message: messageController.text, isUser: true, isNavigate: false, time: DateTime.now().toString()));
                        scrollController.animateTo(scrollController.position.maxScrollExtent + 100, duration: const Duration(microseconds: 500), curve: Curves.bounceIn);
  ...
  callAddMessageApi(String message, String time, String isUser) {
    ...
    try {
      ...
      NetworkClass.fromNetworkClass(addMessageApiUrl, this, addMessageApiReq, map).callRequestServiceHeader(false, "post", null);
  ...
  callGetMessageApi() {
    try {
      NetworkClass(getMessageApiUrl, this, getMessageApiReq).callRequestServiceHeader(false, "get", null);
    } on Exception catch (exception) {
      debugPrint(exception.toString());
    }
  }
  ...
  void sendLocalMessage(bool isHumanAssistanceRequested, String msg) {
    chatList.add(ChatModel(message: msg, isUser: false, isNavigate: isHumanAssistanceRequested, time: DateTime.now().toString()));
    setState(() {});
    scrollController.animateTo(scrollController.position.maxScrollExtent + 80, duration: const Duration(microseconds: 500), curve: Curves.bounceIn);
  }

  void getResponse() async {
    final wit = WitManager(
      utterance: searchValue,
      // headers: "M33D2ZQY7R3JFRX35GYXFRPSNCRBPZGS",
    ...
    if (response != null) {
      response['traits'].forEach((key, valueList) {
        for (var item in valueList) {
          ...
          chatList.add(ChatModel(message: botReply, isUser: false, isNavigate: key == "request_human_assistance", time: DateTime.now().toString()));
      ...
      failCount++;
      // if (failCount>1) {
      //   hasShownFirstFailMsg = true;
      // } else {
      //   hasShownFirstFailMsg = false;
      // }
      if (intentList.isEmpty || isKeyEmptyMap(response, "traits")) {

        final isHumanAssistanceRequested = isHuman(response["text"]);
        chatList.add(
          ChatModel(
              message: (isHumanAssistanceRequested || failCount>1) ? "Hmm... I’m not quite sure about that one! Shall I grab a human from the PressHop team to assist you?" : "I’m sorry, I didn’t quite get that! Can you repeat or rephrase your question? I’m eager to help.",
              isUser: false,
        ...
        if (!isHumanAssistanceRequested  && failCount==0) {
          callAddMessageApi(isHumanAssistanceRequested ? "Hmm... I’m not quite sure about that one! Shall I grab a human from the PressHop team to assist you?" : "I’m sorry, I didn’t quite get that! Can you repeat or rephrase your question? I’m eager to help.", DateTime.now().toString(), "false");
        }
    ...
    try {
      switch (requestCode) {
        ...
        case getMessageApiReq:
          ...
          chatList.add(ChatModel(message: "Hiya, I’m Emily, your digital assistant at PressHop. How can I help? ", isUser: false, isNavigate: false, time: DateTime.now().toString()));

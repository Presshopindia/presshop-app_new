...
const contentImageUrl ="https://uat-cdn.presshop.news/public/contentData/";
const imageUrlBefore ="https://uat.presshop.live/presshop_rest_apis/public/contentData/";
...
//const socketUrl ="https://uat.presshop.live:3005/socket.io";
const socketUrl ="https://uat.presshop.live:3005";
...
const contactUsSubmitMessage = "Thank you for contacting us. We will get back very soon. Cheers!";
const uploadDocErrorMessage = "Due to a technical error, this document was not uploaded. Please try again. Thanks";
const uploadDocMessage = "Thank you for uploading your documents";
const errorOpenSMS = "Due to a technical error, your SMS application can't be opened. Please try again!";
const errorOpenWhatsapp = "Due to a technical error, your Whatsapp application can't be opened. Please try again!";
...
dynamic numberFormatting(dynamic number){
    ...
    try{
        if(value.length==1){
            ...
            String decimalFormatting = parseValue.toStringAsFixed(parseValue.truncateToDouble() == parseValue ? 0 : 2);
...
String dateTimeFormatter({required String dateTime,String format = "d MMM yyyy", bool time = false, bool utc = false}) {
...
/// Share
Future<void> shareLink({required String title,required String description, required String taskName}) async {
    await Share.share(
        "Please check out $taskName \n $title \n\n $description"
            "Post\n$baseShareUrl");
}

  ...
  getSharedPreferences().then((value) {
    ...
    runApp(MaterialApp(
      ...
      theme: ThemeData(
          ...
          useMaterial3: false),
      home: //BroadCastScreen(taskId: '65f0006a63178dfaaf72ac56', mediaHouseId: '',)
          const SplashScreen(),
    ));
  });
}
...
Future<void> uploadMediaUsingDio(String endUrl, Map<String, String>? jsonBody,
    List filePathList, String imageParams,) async {
...
void _showProgressNotification(FlutterLocalNotificationsPlugin notificationPlugin, int progress) {
...
void _showCompletionNotification(FlutterLocalNotificationsPlugin notificationPlugin) {
  notificationPlugin.show(
    0,
    'Upload Complete',
...
void _showErrorNotification(FlutterLocalNotificationsPlugin notificationPlugin) {
  notificationPlugin.show(
    0,
    'Upload Failed',
